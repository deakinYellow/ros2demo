...
public:
        ...
        : Node(nodeName())
    {
        ...
        timer = this->create_wall_timer( 500ms, std::bind(&BubbleRobNode::timerCallback, this) );
    }
    ...
    std::string nodeName() {
        ...
        std::string nodeName("ros2EtvControlNode");
    ...
    void timerCallback()
    {
        ...
        std::cout << "ros2 timer callBack." << std::endl;
        ...
        float desiredLeftMotorSpeed = 1;
        float desiredRightMotorSpeed = 0.1;
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "ros2EtvRob just started" << std::endl;
    ...
    std::string sensorTopic="/sensor";
    std::string simulationTimeTopic="/simulation";
    ...
    std::cout << "ros2EtvRob just ended" << std::endl;
